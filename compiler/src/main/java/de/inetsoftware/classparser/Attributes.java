...
public class Attributes {
    ...
    Attributes( DataInputStream input, ConstantPool constantPool ) throws IOException {
        this.constantPool = constantPool;
        this.attributes = readAttributs( input );
    }

    private AttributeInfo[] readAttributs( DataInputStream input ) throws IOException {
    ...
    static class AttributeInfo {
        ...
        AttributeInfo( DataInputStream input, ConstantPool constantPool ) throws IOException {
